...
const aliases:Record<string,string[]>={
 ...
 ASML:['ASML'],SAP:['SAP SE','SAP'],SIE:['Siemens'],ALV:['Allianz'],MC:['LVMH','Louis Vuitton Moet Hennessy'],OR:["L'Oreal",'LOréal'],AIR:['Airbus'],TTE:['TotalEnergies','Total Energies'],NESN:['Nestlé','Nestle'],ROG:['Roche'],NOVN:['Novartis'],NOVO_B:['Novo Nordisk'],AZN:['AstraZeneca'],SHEL:['Shell plc','Royal Dutch Shell','Shell'],HSBA:['HSBC'],ULVR:['Unilever'],
